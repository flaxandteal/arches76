"""
Django settings for arches76 project.
"""
...
DATATYPE_LOCATIONS.append("arches76.datatypes")
FUNCTION_LOCATIONS.append("arches76.functions")
ETL_MODULE_LOCATIONS.append("arches76.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches76.search_components")
...
SECRET_KEY = "django-insecure-pr1_6j31t#0+21w$f!8xu0^-vtl@rm=zp)uk&tk^*9#2!&ku++"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches76.urls"
ROOT_HOSTCONF = "arches76.hosts"

DEFAULT_HOST = "arches76"
...
ELASTICSEARCH_PREFIX = "arches76"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches76.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches76",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches76.wsgi.application"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches76.search.es_mapping_modifier.EsMappingModifier"]
